 ...
 */
    $id = get_the_ID();
    $post_gallery_metabox = get_post_meta($id, 'tx_post_gallery_meta', true) ? get_post_meta($id, 'tx_post_gallery_meta', true) : [];
    ...
    $enable_blog_button = cs_get_option( 'enable_blog_button' );
